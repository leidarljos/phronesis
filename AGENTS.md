...
3. **Cap'n is the language.** Product API is Cap'n methods (`policyd_check_shell`, …).
4. Public Cap'n interface: `schema/policy.capnp` + `schema/util.capnp`. Do not invent parallel DTOs.
