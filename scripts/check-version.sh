...
check "#define POLICYD_VERSION \"$ver\"" "$hdr" "VERSION string"
check "#define POLICYD_VERSION_MAJOR $major" "$hdr" "VERSION_MAJOR"
check "#define POLICYD_VERSION_MINOR $minor" "$hdr" "VERSION_MINOR"
check "#define POLICYD_VERSION_PATCH $patch" "$hdr" "VERSION_PATCH"
check "#define POLICYD_API_VERSION $api" "$hdr" "API_VERSION"
