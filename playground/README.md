...
| `PHRONESIS_JANET_PACK` | Default `/policy/shell.janet:/policy/packs.d` |
| `PHRONESIS_PACK_ROOT` | `/policy` |
| `PHRONESIS_DEV_PACK` | `1` |
...
PUBLIC_BASE=/grokos-packages/phronesis/ npm run build
```
